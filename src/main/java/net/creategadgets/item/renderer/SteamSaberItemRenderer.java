package net.creategadgets.item.renderer;
...
import net.creategadgets.utils.AnimUtils;
import net.creategadgets.item.model.SteamSaberItemModel;
import net.creategadgets.item.SteamSaberItem;
import net.creategadgets.interfaces.RendersPlayerArms;
...
public class SteamSaberItemRenderer extends GeoItemRenderer<SteamSaberItem> implements RendersPlayerArms {
	public SteamSaberItemRenderer() {
		super(new SteamSaberItemModel());
	}

	@Override
	public RenderType getRenderType(SteamSaberItem animatable, float partialTick, PoseStack poseStack, MultiBufferSource bufferSource, VertexConsumer buffer, int packedLight, ResourceLocation texture) {
		return RenderType.entityTranslucent(getTextureLocation(animatable));
	}

	static {
		AnimationController.addModelFetcher(animatable -> {
			if (animatable instanceof SteamSaberItem) {
				Item item = (Item) animatable;
				BlockEntityWithoutLevelRenderer ister = new SteamSaberItemRenderer();
	...
	protected SteamSaberItem animatable;
	...
	@Override
	public void render(GeoModel model, SteamSaberItem animatable, float partialTicks, RenderType type, PoseStack matrixStackIn, MultiBufferSource renderTypeBuffer, VertexConsumer vertexBuilder, int packedLightIn, int packedOverlayIn, float red,
	...
	@Override
	public void render(SteamSaberItem animatable, PoseStack stack, MultiBufferSource bufferIn, int packedLightIn, ItemStack itemStack) {
	...
	@Override
	public ResourceLocation getTextureLocation(SteamSaberItem instance) {
		return super.getTextureLocation(instance);
	}

	@Override
	public Integer getUniqueID(SteamSaberItem animatable) {
